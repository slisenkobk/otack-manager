...
<div class="form-builder" data-form-builder data-form-id="<?= $form ? (int)$form['id'] : '' ?>">
  ...
  <div class="builder-toolbar" data-builder-toolbar>
    ...
    <div class="builder-toolbar__right">
      <button type="button" class="btn btn--secondary" data-action="add-field"><i class="fa-solid fa-plus"></i> <?= e(t('forms.add_field')) ?></button>
      <?php if ($form): ?>
        <a class="btn btn--secondary" href="<?= e(\abs_url('/f/' . $form['hash'])) ?>" target="_blank" rel="noopener"><i class="fa-solid fa-arrow-up-right-from-square"></i> <?= e(t('forms.open_public')) ?></a>
      <?php endif; ?>
  ...
  <?php if ($form): ?>
    <section class="builder-panel">
      ...
      <div class="public-url-row" data-public-url-row data-form-id="<?= (int)$form['id'] ?>">
        ...
        <button type="button" class="btn btn--ghost" data-action="rotate-url" title="<?= e(t('forms.rotate_title')) ?>">
