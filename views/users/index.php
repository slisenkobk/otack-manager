          ...
          <td class="data-table__cell--actions">
            <div class="user-actions" data-actions>
              <?php if ($u['status'] === 'pending'): ?>
                <button class="btn btn--secondary" data-action="approve" type="button" title="<?= e(t('users.action.approve')) ?>">
                  <i class="fa-solid fa-check"></i> <?= e(t('users.action.approve')) ?>
                </button>
              <?php endif; ?>
              <a class="btn btn--secondary" href="/users/<?= (int)$u['id'] ?>" title="<?= e(t('users.action.view')) ?>">
                <i class="fa-solid fa-eye"></i>
              </a>
              <button class="btn btn--secondary" data-action="edit-user" type="button" title="<?= e(t('users.action.edit')) ?>">
                <i class="fa-solid fa-pen"></i>
              </button>
              <?php if ($u['status'] !== 'blocked' && (int)$u['id'] !== (int)$currentUserId): ?>
                <button class="btn btn--secondary" data-action="block" type="button" title="<?= e(t('users.action.block')) ?>">
                  <i class="fa-solid fa-ban"></i>
                </button>
              <?php endif; ?>
              <?php if ((int)$u['id'] !== (int)$currentUserId): ?>
                <button class="btn btn--danger" data-action="delete" type="button" title="<?= e(t('users.action.delete')) ?>">
