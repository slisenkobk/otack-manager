  ...
  <aside class="brief brief--wide submission-aside" data-sub-id="<?= (int)$sub['id'] ?>">
    ...
    <?php if (!$converted): ?>
      <div class="submission-card__section">
        ...
        <button type="button" class="btn btn--secondary submission-card__cta submission-card__cta--tight" data-action="convert-task">
    ...
    <div class="submission-card__section submission-card__section--danger">
      <button type="button" class="btn btn--danger submission-card__delete" data-action="delete-sub">
