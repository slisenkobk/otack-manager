...
<div class="poll-builder" data-poll-builder data-poll-id="<?= $poll ? (int)$poll['id'] : '' ?>">
      ...
      <div class="field builder-grid__span">
        ...
        <div class="wysiwyg-host">
          <div class="wysiwyg-editor"
               ...
               data-placeholder="<?= e(t('polls.description_placeholder')) ?>"><?= $poll['description'] ? \App\Service\HtmlSanitizer::clean((string)$poll['description']) : '' ?></div>
        </div>
        ...
        <input type="hidden" id="poll-description-hidden" value="<?= e($poll['description'] ? \App\Service\HtmlSanitizer::clean((string)$poll['description']) : '') ?>">
      </div>
    </div>
  </section>
  ...
  <section class="builder-panel">
    ...
    <p class="muted field-hint"><?= e(t('polls.contact_section_hint')) ?></p>
    <div class="builder-grid">
      <div class="field">
  ...
  <section class="builder-panel">
    ...
    <p class="muted field-hint"><?= e(t('polls.choice_section_hint')) ?></p>
    <div class="field">
  ...
  <section class="builder-panel">
    ...
    <p class="muted field-hint"><?= e(t('polls.integration.hint')) ?></p>
    <div class="builder-grid">
      <div class="field">
  ...
  <section class="builder-panel">
    ...
    <p class="muted field-hint"><?= e(t('polls.success.hint')) ?></p>
    <div class="field">
